...
router.post('/:familyMemberId', upload.single('activityPhoto'), physicalActivityController.addActivity);
...
router.put('/:familyMemberId/:activityId', upload.single('activityPhoto'), physicalActivityController.updateActivity);
