...
router.post('/:familyMemberId', simpleUpload.single('mealPhoto'), nutritionController.addNutrition);
...
router.put('/:familyMemberId/:nutritionDataId', simpleUpload.single('mealPhoto'), nutritionController.updateNutrition);
